                ...
                FAuth.sendPasswordResetEmail(forgetpassword.getEditText().getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            mDialog.dismiss();
                            my.foodon.app.ReusableCodeForAll.ShowAlert(ChefForgotPassword.this, "", "Password has been sent to your Email");
                        } else {
                            mDialog.dismiss();
                            my.foodon.app.ReusableCodeForAll.ShowAlert(ChefForgotPassword.this, "Error", task.getException().getMessage());
                        }
                    }
                });
            }
