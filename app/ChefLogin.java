                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (FAuth.getCurrentUser().isEmailVerified()) {
                                        ...
                                        my.foodon.app.ReusableCodeForAll.ShowAlert(ChefLogin.this, "", "Please Verify your Email");
                                    }

                                } else {

                                    mDialog.dismiss();
                                    my.foodon.app.ReusableCodeForAll.ShowAlert(ChefLogin.this, "Error", task.getException().getMessage());
                                }
                            }
                        });
