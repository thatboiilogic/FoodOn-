...
public class ChefRegistration extends AppCompatActivity {
    ...
    String[] ChiangMai = {"MueangChiangMai","ChomThong","ChiangDao"};
    String[] SamutPrakan = {"PhraPradaeng", "BangPhli", "PhraSamutChedi"};


    String[] Bangkok = { "BangBon" , "BangKapi", "BangKhae", "BangKhoLaem", "BangNa", "BangPhlat", "BangSue", "BangkokNoi",
        "BangkokYai", "BuengKum", "Chatuchak", "ChomThong", "DinDaeng", "DonMueang", "HuaiKhwang", "KhanNaYao", "KhlongSamWa",
        "KhlongSan" , "KhlongToei", "LakSi", "LatKrabang" , "LatPhrao", "MinBuri", "NongChok", "NongKhaem", "PhasiCharoen", "SuanLuang",
        "TalingChan", "ThawiWatthana" };


    String[] ChiangRai = {"Thoeng", "Phan", " MaeChan", "ChiangSaen", "WiangChai"};
    String[] Trang = {"Kantang", "Palian", "Sikao", "HuaiYot"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("ChiangMai")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : ChiangMai) {
                        list.add(text);
                    }
                ...
                if (statee.equals("SamutPrakan")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : SamutPrakan) {
                        list.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegistration.this, android.R.layout.simple_spinner_item, list);
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("Bangkok")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Bangkok) {
                        listt.add(text);
                    }
                ...
                if (cityy.equals("ChiangRai")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : ChiangRai) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegistration.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
                ...
                if (cityy.equals("Trang")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Trang) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegistration.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            mDialog.dismiss();
                                                            my.foodon.app.ReusableCodeForAll.ShowAlert(ChefRegistration.this, "Error", task.getException().getMessage());
