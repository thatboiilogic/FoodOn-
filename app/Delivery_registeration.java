...
public class Delivery_registeration extends AppCompatActivity {
    ...
    String[] ChiangRai = {"Mumbai", "Pune", "Aurangabad"};
    String[] ChiangMai = {"Ahemdabad", "Rajkot", "Surat"};


    String[] Bangkok = {"Churchgate", "Marine Lines", "Charni Road", "Grant Road", "Mumbai Central", "Mahalakshmi", "Lower Parel", "Prabhadevi",
    ...
    String[] Trang = {"Hinjewadi", "Wagholi", " Ambegaon", "Undri", "Katraj"};
    String[] SamutPrakan = {"Aarif Colony", "Baiji Pura", "Balaji Nagar", "Angoori Bagh"};
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            mDialog.dismiss();
                                                            my.foodon.app.ReusableCodeForAll.ShowAlert(Delivery_registeration.this, "Error", task.getException().getMessage());
